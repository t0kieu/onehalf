...
[![version tag](https://img.shields.io/github/tag/t0kieu/themes-onehalf.svg?style=flat-square)](https://github.com/t0kieu/themes-onehalf/releases)
[![license tag](https://img.shields.io/github/license/t0kieu/themes-onehalf.svg?style=flat-square)](https://github.com/t0kieu/themes-onehalf/blob/master/LICENSE.txt)

A color scheme for Sublime Text, (Neo)Vim, iTerm, and more. Based on Atom's One.

- Name: themes One Half
- Repo: https://github.com/t0kieu/themes-onehalf
- License: MIT
...
- Support a wide range of editors and terminals for a consistent color theme.
  ...
  - [ ] Pygments
  - [ ] Prism
  - [Add Your Suggestion](https://github.com/t0kieu/themes-onehalf/issues/new)
...
Install with Vundle then set `colorscheme` and `g:airline_theme`:
    ...
    Bundle 't0kieu/themes-onehalf', {'rtp': 'vim/'}
...
Contributions are welcome. Feel free to [open an issue](https://github.com/t0kieu/themes-onehalf/issues/new)
